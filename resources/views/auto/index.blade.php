                ...
                <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8 overflow-auto">
                    ...
                    <table id="example"
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="border px-4 py-2 p-3 text-sm tracking-wide text-left">{{$autos->id}}</td>
                                <td class="border px-4 py-2 p-3 text-sm tracking-wide text-left">{{$autos->titular_id}}</td>
                                <td class="border px-4 py-2 p-3 text-sm tracking-wide text-left">{{ucwords($autos->titular->apellido) . ', ' . ucwords($autos->titular->nombre)}}</td>
                                <td class="border px-4 py-2 p-3 text-sm tracking-wide text-left">{{ucwords($autos->marca)}}</td>
                                <td class="border px-4 py-2 p-3 text-sm tracking-wide text-left">{{ucwords($autos->modelo)}}</td>
                                <td class="border px-4 py-2 p-3 text-sm tracking-wide text-left">{{strtoupper($autos->patente)}}</td>
                                <td class="border px-4 py-2 p-3 text-sm tracking-wide text-left">{{strtoupper($autos->tipo)}}</td>
