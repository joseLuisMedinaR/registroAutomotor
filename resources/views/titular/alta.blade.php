        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="backdrop-blur-lg mx-auto bg-opacity-80 rounded-lg shadow-lg p-5 bg-gray-900 text-white">
                    <h1 class=" text-3xl font-bold pb-5">Nuevo Titular</h1>
                    <form action="{{ route('titular.store') }}" method="POST" name="alta" id="alta">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="apellido" name="apellido"
                                ...
                                placeholder="Simpsons" required value="{{ old('apellido') }}">
                            @error('apellido')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="nombre" name="nombre"
                                class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-full py-2.5 px-4"
                                placeholder="Homer" required value="{{ old('nombre') }}">
                            @error('nombre')
                                <div class="text-xl font-semibold">
                                    <span>{{ $message }}</span>
                                </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="dni" name="dni"
                                class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-full py-2.5 px-4"
                                placeholder="12345678" required value="{{ old('dni') }}">
                            @error('dni')
                                <div class="text-xl font-semibold">
                                    <span>{{ $message }}</span>
                                </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="domicilio" name="domicilio"
                                class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-full py-2.5 px-4"
                                placeholder="Avenida Siempre Viva 742" required value="{{ old('domicilio') }}">
                            @error('domicilio')
                                <div class="text-xl font-semibold">
                                    <span>{{ $message }}</span>
                                </div>
